...
ANNOTATED_VIDEO = 'raccoon_1_annotated.mp4'
RESULTS = 'results'
...
# Path to videos
PATH_TO_VIDEO = os.path.join(CWD_PATH,RESULTS,VIDEO_NAME)
PATH_TO_RESULT_VIDEO = os.path.join(CWD_PATH,RESULTS,ANNOTATED_VIDEO)
...
video_writer = imageio.get_writer(PATH_TO_RESULT_VIDEO, fps=20)
